...
// ResidualCategory classifies a check.Check by what remediation it needs beyond
...
func ResidualCategory(c check.Check) string {
	switch c {
	case check.Checks.Font.SimpleNotEmbedded, check.Checks.Font.CIDNotEmbedded,
		check.Checks.Font.SubsetGlyphCoverage, check.Checks.Font.InvalidProgram,
		check.Checks.Font.CMapNotEmbedded:
	...
	case check.Checks.Structure.StringTooLong:
