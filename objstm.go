...
func (d *Document) resolveCompressedObject(ref PDFRef, entry compressedXrefEntry) (PDFValue, error) {
...
func (d *Document) decodeObjStm(streamObjNum int) ([]objStmEntry, error) {
